...
public class Student extends User implements iMenu {
    ...
    public void menu() {
        ...
        studentMenuStage.setTitle("Saff Library - Student Menu");
        ...
        String buttonStyle = "-fx-background-color: #FFC0CB; -fx-text-fill: #000000;"; // Light pink button with black text

        borrowedBookButton.setStyle(buttonStyle);
        borrowBookButton.setStyle(buttonStyle);
    ...
    public static void returnBooks(){
        ...
        returnBooksStage.setTitle("Saff Library - Pengembalian buku");
        ...
        //Font Color
        headerTitle.setStyle("-fx-text-fill: #FFC0CB;");
